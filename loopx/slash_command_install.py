    ...
    specs: list[dict[str, Any]] = [
        {
            ...
            "instructions": [
                ...
                "Identify the exact current host surface (codex-app, codex-app-ssh, codex-ide-plugin, codex-cli-tui, opencode, traex-cli, pi, gemini-cli, cursor-agent, deepseek-harness, or ark-managed-agent).",
